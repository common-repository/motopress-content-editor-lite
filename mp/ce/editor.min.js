...
(this.editor=tinyMCE.get(this.editorId));this.saveBtn=this.element.find("#motopress-save-code-content");var a=this.element.find("#wp-"+this.editorId+"-editor-tools");0===a.height()&&a.height(33);this.element.mpmodal({backdrop:"static",show:!1});d(window).on("resize",this.proxy("resize"));MP.Utils.addWindowFix();if(parent.MP.Utils.version_compare(parent.motopressCE.settings.wp.wordpress_version,"4.0.0",">="))this.element.find(".wp-switch-editor.switch-html, .wp-switch-editor.switch-tmce").on("click",
